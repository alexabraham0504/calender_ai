...
const EventModal: React.FC<EventModalProps> = ({ isOpen, onClose, onEventAdded, event }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const eventData = { title, startDate, endDate, description, recurrence, color };
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-3 pt-4 border-t border-gray-100 mt-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition shadow-lg shadow-blue-200 disabled:opacity-70"
                        >
